        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav>
            ...
            <NavLink eventKey="4" as={Link} to="/checkInOut">
              <IconSvg
                photoURL={"check-to-slot-solid.svg"}
                width="50px"
                height="50px"
              />
              {" Marcar"}
            ...
            <NavLink eventKey="6" as={Link} to="/expenseRecord">
              <IconSvg
                photoURL={"money-bill-trend-up-solid.svg"}
                width="50px"
                height="50px"
              />
              {" Gastos"}
